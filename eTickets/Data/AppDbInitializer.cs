            ...
            using(var serviceScope = applicationBuilder.ApplicationServices.CreateScope()) {
                ...
                if(!context.Cinema.Any()) {
                    context.Cinema.AddRange(new List<Cinema> {
                        ...
                        new Cinema() {
                            ...
                            Logo = "../wwwroot/imgs/vipmorton.png",
                        ...
                        new Cinema() {
                            ...
                            Logo = "../wwwroot/imgs/willowknolls.png",
                ...
                if(!context.Producers.Any()) {
                    context.Producers.AddRange(new List<Producer> {
                        new Producer() {
                            ProfilePictureUrl = "../wwwroot/imgs/cameronmackintosh.jpg",
                        ...
                        new Producer() {
                            ProfilePictureUrl = "../wwwroot/imgs/carlossaldanha.jpg",
                        ...
                        new Producer() {
                            ProfilePictureUrl = "../wwwroot/imgs/janethealy.jpg",
                        ...
                        new Producer() {
                            ProfilePictureUrl = "../wwwroot/imgs/reynolds.jpg",
                        ...
                        new Producer() {
                            ProfilePictureUrl = "../wwwroot/imgs/timburton.jpg",
                            FullName = "Tim Burton",
                ...
                if(!context.Actors.Any()) {
                    context.Actors.AddRange(new List<Actor> {
                        new Actor() {
                            ProfilePictureUrl = "../wwwroot/imgs/amandaseyfried.jpg",
                        ...
                        new Actor() {
                            ProfilePictureUrl = "../wwwroot/imgs/hughjackman.jpg",
                        ...
                        new Actor() {
                            ProfilePictureUrl = "../wwwroot/imgs/stevecarrel.jpg",
                        ...
                        new Actor() {
                            ProfilePictureUrl = "../wwwroot/imgs/zacharylevi.jpg",
                        ...
                        new Actor() {
                            ProfilePictureUrl = "../wwwroot/imgs/ortega.jpg",
                ...
                if(!context.Movies.Any()) {
                    context.Movies.AddRange(new List<Movie> {
                        new Movie() {
                            ...
                            Price = 7.49,
                            PosterUrl = "../wwwroot/imgs/bjbj.jpg",
                        ...
                        new Movie() {
                            ...
                            Price = 10.99,
                            PosterUrl = "../wwwroot/imgs/dpw.jpg",
                        ...
                        new Movie() {
                            ...
                            Price = 10.99,
                            PosterUrl = "../wwwroot/imgs/dm4.jpg",
                            StartDate = DateTime.Now.AddDays(-10),
                        ...
                        new Movie() {
                            ...
                            Price = 6.25,
                            PosterUrl = "../wwwroot/imgs/pcray.jpg",
                        ...
                        new Movie() {
                            ...
                            Price = 11.00,
                            PosterUrl = "../wwwroot/imgs/lemis.jpg",
                            StartDate = DateTime.Now.AddDays(-3),
